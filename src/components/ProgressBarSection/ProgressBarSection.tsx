...
export default function ProgressBarSection() {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-1 py-2 sm:px-2 sm:py-3 lg:p-6 bg-white/80 dark:bg-gray-900/80 rounded-xl lg:rounded-2xl shadow-lg w-full">
